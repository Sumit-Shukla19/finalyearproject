    ...
    <div class="container">
        ...
        <?php 
         ...
         $i=0;
            ...
            $select_query_count="SELECT * FROM courses  WHERE category=$course_c";
            $find_count=mysqli_query($connection,$select_query_count);
            $count=mysqli_num_rows($find_count);
          
            // if(isset($_POST['submit']))
            //  { $search= $_POST['search'];
                $query="SELECT * FROM courses WHERE category=$course_c LIMIT $page_1, $per_page";
...
<!-- Blog Sidebar Widgets Column -->
    ...
    <ul class="pager">
        ...
        for($i=1;$i<=ceil($count/$per_page);$i++){
            ...
            echo "<li><a href='category.php?page={$i}&category=$course_c'>$i</a></li>";
        }
    }
        ?>
    </ul>
